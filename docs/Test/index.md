...
!!! note
    ...
    The files listed at [Test] and [Test2] are from
    [examples/syntax/highlighting] in the Agda repository.

    The pragmas for the old bindings for the built-in `NIL` and `_::_`
