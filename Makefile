...
# 	(The shell variables html2docs and docs2md could be Make variables:)
	...
	for file in $(HTML)/*.html; do \
	    ...
	    module=$${path%.*}; \
	    _='# Determine whether the module is an index module:'; \
	    ...
	    _='# by replacing `.`s with `/`s and `//` by `/` in the module name:'; \
...
# 	Append CSS for emphasising module definitions to Agda.css:
	@printf "\n%s {\n  %s\n  %s\n}" ".Agda a.Module.Definition" \
		...
		"font-weight: bold;" \
	    >> $(HTML)/Agda.css
# 	Report location of generated HTML pages:
...
# the navigation.sections feature is enabled, resp. disabled.
#
